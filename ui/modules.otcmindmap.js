...
(function () {
  ...
  function ensureStyles() {
    ...
    s.textContent = [
      ...
      ".om .om-lg{border:1px solid var(--bd);border-radius:12px;background:var(--pnl);margin-bottom:10px}",
      ...
      ".om .om-lg-bd{max-height:0;overflow:hidden;padding:0 8px;transition:max-height .25s ease,padding .25s ease}",
      ".om .om-lg-bd.open{max-height:2000px;overflow:visible;padding:8px}",
