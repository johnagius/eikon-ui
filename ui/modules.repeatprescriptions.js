(function () {
  ...
  function openEntryModal(opts) {
    ...
    var body =
      ...
      "    <input id='rp-client-name' type='text' placeholder='Name Surname' value='" +
      esc(initial.client_name) +
      "' />" +
      "  </div>" +
      "  <div class='eikon-form-row'>" +
      "    <label>Client ID</label>" +
      "    <input id='rp-client-id' type='text' placeholder='ID / Passport / etc.' value='" +
      esc(initial.client_id) +
      "' />" +
      "  </div>" +
      "  <div class='eikon-form-row'>" +
      "    <label>Medicine Name &amp; Dose</label>" +
      "    <input id='rp-med' type='text' placeholder='e.g. Amoxicillin 500mg' value='" +
      esc(initial.medicine_name_dose) +
      "' />" +
      "  </div>" +
      "  <div class='eikon-form-row'>" +
      "    <label>Posology</label>" +
      "    <input id='rp-pos' type='text' placeholder='e.g. 1 tab tds' value='" +
      esc(initial.posology) +
      "' />" +
      "  </div>" +
      "  <div class='eikon-form-row'>" +
      "    <label>Prescriber Name</label>" +
      "    <input id='rp-prescriber' type='text' placeholder='Doctor Name' value='" +
      esc(initial.prescriber_name) +
      "' />" +
      "  </div>" +
      "  <div class='eikon-form-row'>" +
      "    <label>Prescriber Reg No</label>" +
      "    <input id='rp-presc-reg' type='text' placeholder='Registration No' value='" +
      esc(initial.prescriber_reg_no) +
      "' />" +
      "  </div>" +
      "</div>";
  ...
  async function render(ctx) {
    ...
    mount.innerHTML =
      ...
      "      <div class='rp-sub'>Log repeat prescription supplies. Search filters all columns live.</div>" +
      "    </div>" +
      "    <div class='rp-controls'>" +
      "      <div class='rp-field'>" +
      "        <label for='rp-month'>Month</label>" +
      "        <input id='rp-month' type='month' value='" + esc(state.monthYm) + "' />" +
      "      </div>" +
      "      <div class='rp-field'>" +
